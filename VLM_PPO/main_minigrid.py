...
def main():
    ...
    if "lora" in model_path:
        ...
        if args.q8:
            ...
            base = Qwen2VLForConditionalGeneration.from_pretrained(model_path, load_in_8bit=True)
        elif args.q4:
            ...
            base = Qwen2VLForConditionalGeneration.from_pretrained(model_path, load_in_4bit=True, quantization_config=q4_config)
            ...
            base = Qwen2VLForConditionalGeneration.from_pretrained(model_path, torch_dtype=torch.float16)
            # if 'mistral' in model_path.lower():
