...
def main():
    ...
    if "Qwen2.5" in model_path:
        ...
        hidden_dim = 1536
    value_model = QwenVLMValue(base, processor, hidden_dim)
    ###
    #for loading lora weights for testing purposes
    """
    lora_weights = torch.load("/home/bahaduri/RL4VLM/outputs/dk_vlm_1/model_7.checkpoint", map_location='cpu')
    ...
    rollouts = RolloutStorage(args.num_steps, args.num_processes,
                              envs.observation_space.shape, envs.action_space, args.max_new_tokens, temporal_predictor, args.act_freq_reward, scale=0.00025)
        ...
        for step in range(args.num_steps):
            ...
            if use_epsilon:
                if j > 1:
                    ...
                    step_2 = 0
                epsilon = 0#max(epsilon_min, epsilon_start - (step_2/(args.num_env_steps - 5000)) * (epsilon_start - epsilon_min))
