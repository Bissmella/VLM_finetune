"""
Validation & Testing — VLM Agent on MiniGrid

Extended validation script that evaluates a trained VLM agent and
generates captioned trajectory images for qualitative inspection.
Overlays the agent's predicted actions and reasoning onto environment
frames for debugging and analysis.

Usage:
  See scripts/run_mgDoorKey_valTest.sh for an example launch command.
"""
